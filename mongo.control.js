...
var MongoEach = require('mongo-each');
...
MC.eachCb = function(params) {
  ...
  return new Promise(function(res, err) {
    ...
    MongoClient.connect(params.db, function(e, db) {
      ...
      var workLine = new Function("doc", "cb", params.func);
      ...
      MongoEach(cursor, {
        ...
        process.nextTick(function() {
          ...
          workLine(doc, function (resDoc) {
            if(resDoc) db.collection(params.collection).save(resDoc);
            cb();
          });
        });
      }, function(e) {
